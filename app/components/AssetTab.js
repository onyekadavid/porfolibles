...
export function AssetTab({id,title,qty,tick,holdWallet,price,notes,img}) {
        ...
        const [openProgressUpdate, setOpenPregresUpdate] = React.useState(false);
        const handleClickOpenUpdate = () => setOpenUpdate(true);
        const handleCloseUpdate = () => setOpenUpdate(false);
    

 const handleDelete = async () => {
    setOpenPregres(true);// start progress indicator
    await deleteDoc(doc(db,'assets',id))
    .then(() => {
        setOpenPregres(false);// stop progress indicator
        handleClose();// 
    })
    .catch(e => {
        console.error(e);
 ...
 const updateRecords = async () => {
    setOpenPregresUpdate(true);// start progress indicator
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Are you sure you want to delect this asset!
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
