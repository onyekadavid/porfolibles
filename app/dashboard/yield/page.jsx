...
export default function Yield() {
    ...
    const { values, handleSubmit, touched, errors, handleChange } = useFormik({
        ...
        onSubmit: () => {
            ...
            setpercProfit(percentageProfit);// percentage profit
            ...
            >
                <DialogContent>
                    <div className="w-full">
                        ...
                        <div className="flex justify-between items-center border-b border-gray-300 p-4">
                            <p className="font-thin text-gray-600 ">Initail Price</p>
                        ...
                        <div className="flex gap-4 items-center border border-gray-300 p-4 rounded-md ">
                            <div className="flex flex-col gap-3 border border-gray-300 p-2 rounded-md">
                                ...
                                <blockquote className="flex items-center  p-2">
                                    <p className="font-thin text-gray-800 text-lg uppercase">${assetValue}</p>
                                </blockquote>
                            ...
                            <div className="flex flex-col gap-3 border border-gray-300 p-2 rounded-md">
                                ...
                                <blockquote className="flex items-center  p-2">
                                    <p className="font-thin text-gray-800 text-lg uppercase">{Math.round(percProfit)}</p>
                                </blockquote>
